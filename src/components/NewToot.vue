                                    ...
                                    <transition leave-active-class="transition ease-in duration-100"
                                        ...
                                        <ListboxOptions
                                            ...
                                            <ListboxOption as="template" v-for="mood in moods" :key="mood.value"
                                                ...
                                                <li
                                                    :class="[active ? 'bg-gray-100' : 'bg-white', 'relative cursor-default select-none py-2 px-3']">
                                                    <div class="flex items-center">
                                                        <div
                                                            :class="[mood.bgColor, 'w-8 h-8 rounded-full flex items-center justify-center']">
